...
Try-catch blocks don't compose. You can't map over them. You can't chain them. You end up with nested try-catch pyramids where the innermost handler has no idea what the outer ones already caught. It's spaghetti, but everyone pretends it's architecture.
